...
@function_tool
def insert_user_data(user_name: str,
    ...
    try:
        cursor.execute("INSERT INTO users (user_name, user_date_of_birth, user_age, user_email, user_phone_number, user_address, user_city, user_state, user_zip_code, user_country) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", (user_name, user_date_of_birth, user_age, user_email, user_phone_number, user_address, user_city, user_state, user_zip_code, user_country))
        conn.commit()
        conn.close()
